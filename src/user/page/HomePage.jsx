...
import { MyContext } from "../../assets/AuthContext/authContext"
...
console.log(products);
    ...
    return(
        <>
        <img src="src/assets/carprts.png" alt="" className="w-full h-screen bg-center p-10" />
        <h1>hello</h1>
        ...
        {products.map((item, index) => (
          <div className="w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-2 " key={index}>
            <div className="bg-white shadow-md rounded-lg overflow-hidden  flex flex-col justify-center">
              <img className="w-full h-40 object-fit" src={item.url} alt="" />
